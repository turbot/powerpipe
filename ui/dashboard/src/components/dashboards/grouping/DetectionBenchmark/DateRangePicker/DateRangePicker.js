    ...
    <div className="date-range-picker">
      ...
      {showCustomPanel && selectedPreset === 'custom' && (
        <div
          ...
          style={{
            position: 'absolute',
            top: customButtonRef.current?.getBoundingClientRect().bottom + window.scrollY,
            left: customButtonRef.current?.getBoundingClientRect().left + window.scrollX,
            zIndex: 1000,
