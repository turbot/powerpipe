...
@test "simple dashboard test" {
  ...
  run powerpipe dashboard run sibling_containers_report --export test.sps --output none --mod-location "$FILE_PATH/test_data/mods/dashboard_sibling_containers"
...
@test "dashboard with 'with' blocks" {
  # run a dashboard and shapshot the output
  run powerpipe dashboard run testing_with_blocks --export test.sps --output none --mod-location "$FILE_PATH/test_data/mods/dashboard_withs"
...
@test "dashboard with 'text' blocks" {
  # run a dashboard and shapshot the output
  run powerpipe dashboard run testing_text_blocks --export test.sps --output none --mod-location "$FILE_PATH/test_data/mods/dashboard_texts"
...
@test "dashboard with 'card' blocks" {
  # run a dashboard and shapshot the output
  run powerpipe dashboard run testing_card_blocks --export test.sps --output none --mod-location "$FILE_PATH/test_data/mods/dashboard_cards"
...
@test "dashboard with node and edge blocks" {
  # run a dashboard and shapshot the output
  run powerpipe dashboard run testing_nodes_and_edges --export test.sps --output none --mod-location "$FILE_PATH/test_data/mods/dashboard_graphs"
...
@test "dashboard with 'input' and test --arg" {
  # run a dashboard and shapshot the output
  run powerpipe dashboard run testing_dashboard_inputs --export test.sps --output none --mod-location "$FILE_PATH/test_data/mods/dashboard_inputs" --arg new_input=test
