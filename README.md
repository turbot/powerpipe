...
[![mods](https://img.shields.io/badge/mods-52-blue)](https://hub.powerpipe.io/mods?objectives=dashboard?utm_id=gspreadme&utm_source=github&utm_medium=repo&utm_campaign=github&utm_content=readme) &nbsp;
...
**Modularity and customization**. Dashboards and benchmarks are built with [HCL and SQL](https://powerpipe.io/docs/build), and are available for [remixing and reuse](https://steampipe.io/blog/remixing-dashboards). 
