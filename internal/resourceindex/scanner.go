...
func (s *Scanner) scanBytes(content []byte, filePath string, withOffsets bool) error {
	...
	return s.processBody(body, filePath, withOffsets)
}

func (s *Scanner) processBody(body *hclsyntax.Body, filePath string, withOffsets bool) error {
	for _, block := range body.Blocks {
		...
		s.extractChildren(block.Body, entry)
...
func (s *Scanner) extractChildren(body *hclsyntax.Body, entry *IndexEntry) {
