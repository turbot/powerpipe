...
// Reference represents a reference to another resource (e.g., in children attribute).
type Reference struct {
	AutoGenerated    bool   `json:"auto_generated"`
	EndLineNumber    int    `json:"end_line_number"`
	FileName         string `json:"file_name"`
	FromAttribute    string `json:"from_attribute"`
	FromBlockName    string `json:"from_block_name"`
	FromBlockType    string `json:"from_block_type"`
...
type IndexEntry struct {
	...
	References []Reference `json:"references,omitempty"` // References to children (for benchmarks)
