...
func ResolveResourceAndArgsFromSQLString[T modconfig.ModTreeItem](sqlString string, w *workspace.Workspace) (modconfig.ModTreeItem, *powerpipe.QueryArgs, error) {
	var err error
	var empty T
...
func extractResourceFromQueryString[T modconfig.ModTreeItem](input string, w *workspace.Workspace) (modconfig.ModTreeItem, *powerpipe.QueryArgs, error) {
