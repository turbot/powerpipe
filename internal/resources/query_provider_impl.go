...
func (q *QueryProviderImpl) GetNestedStructs() []modconfig.CtyValueProvider {
	...
	return append([]modconfig.CtyValueProvider{q}, q.RuntimeDependencyProviderImpl.GetNestedStructs()...)
}
