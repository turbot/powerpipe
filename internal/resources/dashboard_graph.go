...
func (g *DashboardGraph) ClearRemain() {
	g.Remain = nil
	g.ResourceWithMetadataImpl.ClearRemain()
	g.WithProviderImpl.ClearRemain()
	g.DashboardLeafNodeImpl.ClearRemain()
	g.NodeAndEdgeProviderImpl.ClearRemain()
}
