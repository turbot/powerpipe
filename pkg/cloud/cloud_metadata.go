...
func GetCloudMetadata(ctx context.Context, workspaceDatabaseString, token string) (*entities.CloudMetadata, error) {
	...
	cloudMetadata := &entities.CloudMetadata{
		Actor: &entities.ActorMetadata{
			Id:     actor.Id,
			Handle: actor.Handle,
		},
		Identity: &entities.IdentityMetadata{
			Id:     cloudWorkspace.IdentityId,
			Type:   identity.Type,
			Handle: identityHandle,
		},
		WorkspaceDatabase: &entities.WorkspaceMetadata{
