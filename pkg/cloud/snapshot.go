...
func PublishSnapshot(ctx context.Context, snapshot *entities.SteampipeSnapshot, share bool) (string, error) {
...
func exportSnapshot(snapshot *entities.SteampipeSnapshot) (string, error) {
...
func uploadSnapshot(ctx context.Context, snapshot *entities.SteampipeSnapshot, share bool) (string, error) {
	...
	entities.StripSnapshot(cloudSnapshot)
...
func resolveSnapshotTitle(snapshot *entities.SteampipeSnapshot) string {
