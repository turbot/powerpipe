...
//}
//
//func NewConnectionState(connection *Connection, creationTime time.Time) *ConnectionState {
...
//}
//
//func (d *ConnectionState) setFilename(connection *Connection) {
...
//		d.GetType() != ConnectionTypeAggregator
//}
//
