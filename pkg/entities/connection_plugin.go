...
//
//	var connectionsToCreate = make([]*Connection, len(connectionNamesToCreate))
...
//}
//
//func handleGetFailures(getResponse *proto.GetResponse, res *RefreshConnectionResult, connectionsToCreate []*Connection) {
...
//		isAggregator := connectionPlugin.ConnectionMap[connectionName].Type == ConnectionTypeAggregator
...
//func createConnectionPlugin(connection *Connection, reattach *proto.ReattachConfig) (*ConnectionPlugin, error) {
//	// we must have a plugin instance
//	if connection.PluginInstance == nil {
//		// unexpected
