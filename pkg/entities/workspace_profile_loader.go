...
var GlobalWorkspaceProfile *WorkspaceProfile
...
type WorkspaceProfileLoader struct {
	...
	DefaultProfile       *WorkspaceProfile
	ConfiguredProfile    *WorkspaceProfile
}
...
func (l *WorkspaceProfileLoader) GetActiveWorkspaceProfile() *WorkspaceProfile {
...
func (l *WorkspaceProfileLoader) get(name string) (*WorkspaceProfile, error) {
...
func (l *WorkspaceProfileLoader) load() (map[string]*WorkspaceProfile, error) {
...
*/
func (l *WorkspaceProfileLoader) getImplicitWorkspace(name string) *WorkspaceProfile {
